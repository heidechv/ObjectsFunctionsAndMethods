...
#            the RoseWindow RENDER draws all the objects attached to the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            the RoseWindow close_on_mouse_click is called at the end of a function. if it was called earlier, the
#            following code would not be executed until the window is closed
