...
def turtle4():
    ...
    elle.pen = rg.Pen('purple', 50)
    elle.speed = 15

    elle.right(90)
    elle.forward(50)
    elle.draw_regular_polygon(3, 300)


def turtle5():
    zsolt = rg.SimpleTurtle()
    zsolt.pen = rg.Pen('red', 5)
    zsolt.paint_bucket = rg.PaintBucket('midnight blue')

    beefy = rg.SimpleTurtle()
    beefy.pen = rg.Pen('black', 20)
    beefy.speed = 5

    zsolt.backward(100)
    zsolt.begin_fill()
    zsolt.draw_circle(50)
    zsolt.end_fill()
